...
::: {.callout-note}
if we have an XLS or XLSX file, we can alternatively use the [`read_excel`](https://pandas.pydata.org/docs/reference/api/pandas.read_excel.html) function.
:::
...
Note: we can upload other CSV files to the Colab Filesystem as well, and read them using this same approach.
