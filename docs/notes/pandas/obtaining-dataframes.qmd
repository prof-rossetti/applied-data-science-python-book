...
In this case, each of the dictionaries becomes its own row, with a column for each of the keys.
...
In this case, each of the keys becomes its own column containing the corresponding list of values.
