...
In this case we wind up with a row for each item in the list, and a column for each value in the dictionary, where the dictionary keys become the column names.
